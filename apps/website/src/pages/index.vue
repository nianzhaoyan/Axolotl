...
.features {
	...
	.feature-grid {
		...
		.playing {
			...
			.launcher-preview {
				position: absolute;
				inset: var(--gap-xl) var(--gap-xl) 7.5rem;
				display: flex;
				align-items: center;
				gap: var(--gap-lg);
				padding: var(--gap-xl);
				border: 1px solid rgb(245 139 174 / 24%);
				border-radius: 1.25rem;
				background: linear-gradient(135deg, rgb(245 139 174 / 14%), rgb(136 103 255 / 8%));
				text-align: left;
...
.main-header-strong {
	font-weight: 600;
	background-color: var(--color-brand);
	background-image: linear-gradient(180deg, #fbcfe8 0%, var(--color-brand) 64%);
	background-size: 100%;
